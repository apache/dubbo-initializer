 ...
 */
@Controller
public class InitializerProjectMetadataController extends ProjectMetadataController {

    private final DependencyMetadataProvider dependencyMetadataProvider;

    public InitializerProjectMetadataController(InitializrMetadataProvider metadataProvider,
    ...
    protected InitializrMetadataJsonMapper getJsonMapper(InitializrMetadataVersion version) {
        String share = "";
        switch (version) {
            case V2:
                return new InitializerMetadataV2JsonMapper(share);
            default:
                return new InitializerMetadataV21JsonMapper(share);
        }
    }
